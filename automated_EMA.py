...
symbol = 'BTC/USDT'  # Update with the correct symbol
pos_size = 50
...
def get_ema_data():
    ...
    while True:  # Continuously fetch live data
        bars = exchange.fetch_ohlcv(
            symbol, timeframe=timeframe, limit=num_bars)
        ...
        print(df_d)
        time.sleep(60)  # Delay for 10 seconds before fetching the next data
